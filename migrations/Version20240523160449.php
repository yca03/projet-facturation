 ...
 */
final class Version20240523160449 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE detail_facture ADD facture_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_9949E4C57F2DEE08 ON detail_facture');
        $this->addSql('ALTER TABLE detail_facture DROP facture_id');
    }
}
