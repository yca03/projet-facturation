 ...
 */
final class Version20241125150848 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offre_commerciale ADD CONSTRAINT FK_95EB2D669620F61D FOREIGN KEY (facture_pro_id) REFERENCES facture_pro_format (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
