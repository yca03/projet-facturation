...
const addFormToCollectionDetailFacture = () => {
    $('#add-collection-detail-facture-pro').click(function (e) {
        const list = $($(this).attr('data-list-selector'));
        const $widget = $('#widget-counter-detail-facture-pro');
        ...
        list.data('widget-counter-detail-facture-pro', index);
        lastIndex = index
        // create a new list element and add it to the list
        $('#table_detail_facture_pro tbody').append(newWidget);
...
const addTagFormDeleteLinkDetailFacture = () => {
    $('body').on('click', '.delete-detail-facture-pro', function () {
